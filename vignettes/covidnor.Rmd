---
title: "Introduction to respiranor"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Introduction to respiranor}
...
The overall data is stored as `total`, and has 419k rows. More information on what variables and specifications are available, and how to extract specifications you want can be found [here](https://www.csids.no/respiranor/articles/data_details.html). 
...
For more details, please refer to the [vignette](https://www.csids.no/respiranor/articles/data_details.html) and [data documentation](https://www.csids.no/respiranor/reference/total_b2020.html).

Several of CSIDS packages ([csstyle](https://www.csids.no/csstyle/index.html),  [csalert](https://www.csids.no/csalert/index.html)) make use of `respiranor` data. You can read the following documentation to find out more, 
